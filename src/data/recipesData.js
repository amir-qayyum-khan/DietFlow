...
export const recipesData = [
  ...
  },
  {
    ...
    breakfast: {
      id: "d7-b",
      title: "Toasted Whole Grain Bagels with Scrambled Eggs, Herbed Labneh, Avocado & Chia Seeds",
      cuisine: "Continental",
      prepTime: "10 mins",
      cookTime: "10 mins",
      calories: "390 kcal per serving",
      macros: { protein: "26g", carbs: "44g", fiber: "8g", fat: "14g" },
      seasonalTip: "Avocado's heart-healthy monounsaturated fats and chia seeds' ALA omega-3 together make a powerful fish-free nutrient combination.",
      healthWarnings: {  },
      modifications: {  },
      supplementNote: "Algae oil DHA supplement (200–300 mg/day, halal-certified) is recommended especially for Members 3 & 5 (expecting and senior) to maintain omega-3 EPA/DHA levels since all fish has been removed from this meal plan.",
      ingredients: [
        ...
        "200g low-fat labneh",
        "2 ripe avocados, peeled and thinly sliced (300g)",
      ...
      instructions: [
        "1. Toast the 10 bagel halves in a toaster or under a broiler for 2–3 minutes until lightly golden and warm.",
        "2. Whisk together 6 eggs, 30ml milk, 2g salt, and 2g black pepper in a bowl until well combined.",
        "3. Heat 10ml olive oil in a non-stick pan over medium-low heat; pour in the egg mixture and gently stir with a spatula every 20 seconds to form soft, creamy scrambled curds. Remove from heat when just set (about 3–4 minutes total).",
        "4. In a small bowl, mix 200g labneh with 5ml lemon juice and 10g chopped chives until smooth.",
        "5. Spread 20g herbed labneh on the base of each toasted bagel half.",
        "6. Top each bagel half with a portion of creamy scrambled egg, 3–4 avocado slices, and thin cucumber rounds.",
        "7. Sprinkle chia seeds and remaining fresh chives evenly over each assembled bagel. Serve immediately while eggs are warm."
      ]
    },
    lunch: {
      id: "d7-l",
  ...
  },
  {
    ...
    dinner: {
      id: "d10-d",
      title: "Baked Chicken Taco Bowls with Crunchy Cabbage Slaw, Avocado Lime Dressing & Hemp Seeds",
      cuisine: "Mexican-Inspired",
      prepTime: "20 mins",
      cookTime: "20 mins",
      calories: "460 kcal per serving",
      macros: { protein: "42g", carbs: "44g", fiber: "9g", fat: "14g" },
      seasonalTip: "Hemp seeds sprinkled over the slaw add plant-based ALA omega-3 and complete protein — a natural boost without altering the taste.",
      healthWarnings: {  },
      modifications: {  },
      supplementNote: "Algae oil DHA supplement (200–300 mg/day, halal-certified) is recommended especially for Members 3 & 5 (expecting and senior) to maintain omega-3 EPA/DHA levels since all fish has been removed from this meal plan.",
      ingredients: [
        "600g halal boneless chicken breast strips",
        "10 whole wheat flour tortillas or small whole wheat pitas (for bowl base or wraps)",
        "300g shredded purple and green cabbage",
        "100g carrots, shredded",
        "1 ripe avocado (150g), blended with 30ml fresh lime juice and 50g low-fat yogurt",
        "15ml olive oil (1 tbsp)",
      ...
      instructions: [
        "1. Preheat oven to 200°C (400°F) and line a baking sheet with parchment paper.",
        "2. Toss 600g chicken breast strips with 15ml olive oil and 10g taco seasoning; arrange in a single layer on the baking sheet.",
        ...
        "4. Blend 1 ripe avocado with 30ml lime juice and 50g yogurt until smooth and creamy; season with salt to taste.",
        "5. In a bowl, toss 300g shredded cabbage and 100g shredded carrots with half of the avocado-lime dressing; sprinkle 20g hemp seeds over the slaw and toss to combine.",
        "6. Warm the tortillas or pitas on a dry skillet for 15 seconds per side until pliable.",
        "7. Assemble bowls: place warm tortilla at the base, arrange baked chicken strips on top, add a generous scoop of hemp-seed slaw, drizzle with remaining avocado lime dressing, and garnish with fresh coriander."
      ]
    }
  },
  {
  ...
  },
  {
    ...
    breakfast: {
      ...
      healthWarnings: { father: "Contains spinach (high Vitamin K). Warfarin users need CONSISTENT daily Vitamin K — serve same portion size on all spinach days to avoid INR fluctuation.", wife: "Heavily spiced dish — may cause heartburn or indigestion during pregnancy. Serve expecting member a lighter, less spiced portion.", daughter: "Spice level may be too high for a 3-year-old. Prepare toddler portion with 1/4 of the stated chili/spice before adding full spice to the main pot.", me: "Dense, high-fiber meal — eat at least 3 hours before lying down to avoid hernia discomfort. Serve a smaller portion. | Legumes and cruciferous vegetables can cause gas — which worsens hernia discomfort. Chew slowly and eat smaller portions." },
      modifications: { father: "Cap spinach to 100g per 5-person pot maximum on spinach days; avoid sudden large spikes.", wife: "Set aside expecting member's portion before final spice tempering (baghar); season this portion lightly with only cumin and coriander.", daughter: "Set aside toddler portion of chicken/meat BEFORE adding chili or heavy spices; season separately with cumin and coriander only.", me: "Eat an 80% portion and walk for 10 minutes after the meal. Avoid lying down for at least 3 hours post-meal. | Soak dried legumes 24 hours and use canned (pre-cooked) versions to reduce gas-producing compounds." },
      supplementNote: "Algae oil DHA supplement (200–300 mg/day, halal-certified) is recommended especially for Members 3 & 5 (expecting and senior) to maintain omega-3 EPA/DHA levels since all fish has been removed from this meal plan.",
      healthWarnings: { father: "Contains spinach (high Vitamin K). Warfarin users need CONSISTENT daily Vitamin K — serve same portion size on all spinach days to avoid INR fluctuation." },
      modifications: { father: "Cap spinach to 100g per 5-person pot maximum on spinach days; avoid sudden large spikes." },
      supplementNote: "Algae oil DHA supplement (200–300 mg/day, halal-certified) is recommended especially for Members 3 & 5 (expecting and senior) to maintain omega-3 EPA/DHA levels since all fish has been removed from this meal plan.",
